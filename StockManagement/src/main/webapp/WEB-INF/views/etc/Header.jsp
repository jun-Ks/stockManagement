...
<body>
	...
	<div class="menu-navi">
		...
		<a href="/stock/request" class="header-menu" id="stockRequestPage">입고요청</a>
		<a href="/stock/location/modi/request" class="header-menu" id="locationModiPage">수량/위치 수정요청</a>
		<a href="/stock/request/list" class="header-menu" id="requestListPage">입고/수정 요청 리스트</a>
		<a href="/stock/management" class="header-menu" id="stock-management">품목관리</a>
		<a href="/stock/location/label" class="header-menu" id="make-label" style="display:none">QR라벨 관리</a>
		...
		<div id="erpModal" class="modal">
			<div class="modal-content">
				...
				<div style="text-align:center; font-size: 18px;">
  					...
  					<p>🧑‍💻 전산팀 호출기능은 현재 개발 중이에요... <br/> 곧 찾아뵙겠습니다! 🐥</p>
				</div>
